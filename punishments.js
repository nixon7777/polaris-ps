...
const PUNISHMENT_FILE = path.resolve(CONFIG_DIR + 'punishments.tsv');
const ROOM_PUNISHMENT_FILE = path.resolve(CONFIG_DIR + 'room-punishments.tsv');
const SHAREDIPS_FILE = path.resolve(CONFIG_DIR + 'sharedips.tsv');
...
Punishments.loadBanlist = function () {
	return new Promise((resolve, reject) => {
		fs.readFile(path.resolve(CONFIG_DIR + 'ipbans.txt'), (err, data) => {
